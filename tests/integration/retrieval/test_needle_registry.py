...
class TestEmbeddingCache:
    ...
    def test_cache_ttl_expiry(self):
        from embeddings import _cache_get, _cache_key, _cache_put, _embed_cache, _embed_cache_lock
    ...
    def test_cache_eviction_at_max(self):
        from embeddings import _EMBED_CACHE_MAX, _cache_put, _embed_cache, _embed_cache_lock
...
class TestQueryExpansionCache:
    def test_expansion_cache_roundtrip(self):
        from query_expansion import _cache_get, _cache_put
    ...
    def test_expansion_cache_ttl_expiry(self):
        from query_expansion import _cache_get, _cache_put, _expansion_cache, _expansion_lock

...
class TestConfigFeatureFlagLogging:
    ...
    def test_log_feature_flags_covers_key_flags(self, caplog):
        ...
        for expected in [
            "BM25_ENABLED", "REVERSE_HYDE_ENABLED", "GRAPH_RETRIEVAL_ENABLED",
            "HOT_CACHE_ENABLED", "RERANK_ENABLED", "METRICS_ENABLED",
        ]:
...
class TestStorePipelineLog:
    ...
    def test_store_log_contains_required_fields(self):
        ...
        for field in [
            "memory_id", "namespace", "agent_id", "chunk_count",
            "micro_chunk_count", "entity_count", "reverse_hyde_queued",
            "duration_ms",
        ]:
...
class TestRetrievalPipelineLog:
    ...
    def test_retrieval_log_contains_required_fields(self):
        ...
        for field in [
            "query_length", "namespace", "agent_id",
            "registry_hits", "vector_results", "bm25_results",
            "graph_entities", "post_threshold", "final_count",
            "expansion_variants", "hyde_used", "ltr_used",
            "duration_ms",
        ]:
...
class TestDocstringsAndTypeHints:
    ...
    def test_result_candidate_factory_docstrings(self):
        ...
        for method in ["from_qdrant_payload", "from_registry_hit", "from_bm25_hit",
                        "update_from_payload", "to_dict"]:

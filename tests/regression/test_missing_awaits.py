"""Regression tests for missing await — write path persistence verification.

Each test directly exercises async graph functions that were previously called
without await. These tests would have been coroutine-no-ops (silent data loss)
before the Phase 2 fixes were applied.
"""

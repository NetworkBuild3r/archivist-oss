...
class TestContextManager:
    def test_check_context_under_budget(self):
        from archivist.utils.context_manager import check_context
    ...
    def test_check_memories_budget(self):
        from archivist.utils.context_manager import check_memories_budget
...
class TestCompaction:
    ...
    def test_format_structured_summary(self):
        from archivist.write.compaction import format_structured_summary

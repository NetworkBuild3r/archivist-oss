"""Unit tests for Chunk 5: BM25 IDF Dilution + FTS5 Quality.
...
class TestStripAugmentationHeader:
    ...
    def test_roundtrip_with_augment_chunk(self):
        from archivist.write.contextual_augment import augment_chunk, strip_augmentation_header
...
class TestEmbeddingCacheImmutability:
    ...
    def test_cache_stores_tuple(self):
        from archivist.features.embeddings import _cache_put, _embed_cache, _embed_cache_lock

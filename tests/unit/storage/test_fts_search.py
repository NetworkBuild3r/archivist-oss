...
class TestFTSSearch:
    ...
    async def test_search_bm25_disabled(self, monkeypatch):
        monkeypatch.setattr("archivist.storage.fts_search.BM25_ENABLED", False)
    ...
    def test_merge_vector_and_bm25_empty_bm25(self):
        from archivist.storage.fts_search import merge_vector_and_bm25
...
class TestPgQueryBuilders:
    ...
    def test_pg_tsquery_and_basic(self):
        from archivist.storage.fts_search import _pg_tsquery_and
    ...
    def test_pg_tsquery_phrase_basic(self):
        from archivist.storage.fts_search import _pg_tsquery_phrase
